...
- System version: v3.0 Desktop Lite
...
This image comes pre-installed with the **LXQt** desktop environment, which starts automatically as a desktop session when a monitor is connected.
