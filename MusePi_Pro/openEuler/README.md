...
# SpacemiT MusePi Pro, openEuler 24.03-LTS-SP1 Test Report
...
The original MusePi Pro uses UEFI as its firmware, but the openEuler uses U-Boot and BootSTD as its firmware. So, we need to flash the firmware to the MusePi Pro's SPI NOR flash. 
