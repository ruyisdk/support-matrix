# SpacemiT MusePi Pro, openEuler 24.03-LTS-SP1 测试报告
...
原版 MusePi Pro 使用 UEFI 作为固件，但 openEuler 使用 U-Boot 和 BootSTD 作为固件。因此，我们需要将固件刷写到 MusePi Pro 的 SPI NOR flash 中。
