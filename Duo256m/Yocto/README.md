...
# Yocto Milk-V Duo 256M Test Report
...
- Three Dupont Lines
- Headers pre-soldered on the Milk-V Duo 256M for debugging purposes
...
The resulting system image would be at `build/tmp-musl/deploy/images/milkv-duo256m/core-image-minimal-milkv-duo256m.rootfs.wic.gz`.
